...
class PotassiumDrivingForceDisplay extends Component {
	...
	render(){
		...
		const latex_string = this.global.parallel_conductance_equation.ions.potassium.calculations.driving_force.steps[0].latex_string;
		const pilot_string = this.global.parallel_conductance_equation.ions.potassium.calculations.driving_force.steps[0].pilot_string;
			...
			return (
				<div className="wadu">
					<Grid>
						<Row center="xs">
							<Col xs={12}>
								<p style={{color: '#E9C46A'}}>Potassium Driving Force</p>
								<hr/>
